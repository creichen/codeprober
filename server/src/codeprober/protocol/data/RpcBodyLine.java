...
public class RpcBodyLine implements codeprober.util.JsonUtil.ToJsonable {
  ...
  public static RpcBodyLine fromJSON(JSONObject obj) {
    ...
    case arr:
      try {
        final java.util.List<RpcBodyLine> val = codeprober.util.JsonUtil.<RpcBodyLine>mapArr(obj.getJSONArray("value"), (arr1, idx1) -> RpcBodyLine.fromJSON(arr1.getJSONObject(idx1)));
        return fromArr(val);
      } catch (org.json.JSONException e) {
        throw new org.json.JSONException("Not a valid RpcBodyLine", e);
      }
  ...
  public void writeTo(codeprober.protocol.BinaryOutputStream dst) throws java.io.IOException {
    ...
    case streamArg:
      ...
      break;
    case arr:
      codeprober.util.JsonUtil.<RpcBodyLine>writeDataArr(dst, ((java.util.List<RpcBodyLine>)value), ent1 -> ent1.writeTo(dst));
      break;
    case node:
